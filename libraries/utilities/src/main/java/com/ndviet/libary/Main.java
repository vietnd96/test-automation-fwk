...
//        String outputPath = TemplateHelpers.processFileTemplate(System.getProperty(CURRENT_WORKING_DIR) + "/libraries/utilities/src/main/resources/template/template_testing.yaml",
...
//        String content = TemplateHelpers.processTemplate("Hello ${firstName} ${lastName}!", values);
